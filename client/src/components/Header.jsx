...
const Header = () => {
  ...
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse  gap-y-10 px-4 mt-10 lg:px-44  sm:mx-7 max-md:mx-10 sm:mt-20'>
         {/*left side*/}
        <div className=''>
           ...
           <p className='my-6 text-[15px] text-gray-500'>Remove image backgrounds instantly with AI. <br /> Upload your photo and get a clean, transparent result in seconds.<br className='max-sm:hidden' /> </p>
              <div>
